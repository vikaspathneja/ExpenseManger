	...
	<div class="container">
		<div class="row">
			<div class='col-sm-6'>
				...
				<form:form method="post" modelAttribute="incomecategorypojo"
					style="display: block;" onsubmit="return validate()">

					<div class="form-group">
						<form:input tabindex="1" path="incomeType" id="type"
							class="form-control" placeholder="Income type" value="" />
		<span id="type_result" style="color: red;"></span>
					...
					<div class="form-group">
						<form:input tabindex="2" path="incomeCategoryDescription"
							...
							placeholder="Income Category Description" value="" />
