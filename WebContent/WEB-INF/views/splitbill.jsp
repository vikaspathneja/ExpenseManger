				...
				<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3">
					...
					<div class="panel panel-success">
						<div class="panel-body">
							<div class="row">
								<div class="col-lg-12">
									<div class="text-center"><h2><b>Split Bill </b></h2></div>
									
									<form:form id="register-form"  method="post" role="form" autocomplete="off" >
									Amount to be Splitted :<input type="number" min="10">	
